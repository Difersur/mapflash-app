...
export default function Home() {
  ...
  // FUNCIÓN PARA GOOGLE (Maneja tanto el registro como el inicio de sesión automático)
          ...
          {tab === 'login' ? (
            <form onSubmit={handleLogin} className="flex flex-col gap-4">
              ...
              <button 
                ...
                className="w-full border border-gray-200 rounded-lg p-3 text-sm flex items-center justify-center gap-2 hover:bg-gray-50"
              >
            ...
            <form onSubmit={handleRegister}>
              ...
              <button type="submit" disabled={cargando || !rol}
                className={`w-full p-3 rounded-lg text-center font-semibold text-sm block transition mb-3 ${rol && !cargando ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-gray-200 text-gray-400 cursor-not-allowed'}`}>
