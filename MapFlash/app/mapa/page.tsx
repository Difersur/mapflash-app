...
export default function MapaPage() {
  ...
  useEffect(() => {
    // 1. Recuperar usuario de la sesión de forma segura
  ...
  const handleCrearAlerta = async (tipo: string) => {
    ...
    // Coordenadas aproximadas por defecto (Lima Central) si no hay geolocalización activa
    let lat = -12.046374;
    let lng = -77.042793;
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 font-sans flex flex-col justify-between">
      ...
      <main className="flex-1 relative bg-slate-950 p-4 flex flex-col gap-4">
        ...
        {/* Panel Inferior para Reportar Incidentes de Tránsito */}
